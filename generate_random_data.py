...
OSH_LEVELS = [True, True, True, False]
...
def create_companies(base_count):
    ...
    for index in range(base_count):
        ...
        company = Company(
            ...
            licence_number=f'LIC-{record_index + 1000}',
            ...
            professional_memberships=random.choice(['HKRIA', 'CIC', 'None']),
            ...
            osh_policy_in_place=random.choice(OSH_LEVELS),
            safety_training_coverage=random.randint(45, 100),
            heavy_lifting_compliance=random.choice([True, False]),
            lifting_equipment_available=random.choice([True, False]),
            ...
            bank_account_years=random.randint(1, 12),
            existing_loans=random.randint(0, 3000000),
            loan_repayment_history=random.choice(['excellent', 'good', 'Good', 'fair', 'poor']),
